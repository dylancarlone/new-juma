...
hero:
  ...
  image: 1410-sf-4.png
intro: Across the San Francisco Bay Area, 27,000 young people ages 16-24 are disconnected from the critical opportunity pathways of school and work. This figure is only sure to drastically increase after the economic impact of the COVID-19 pandemic is fully realized.
stats:
  - value: 27,000
    label: young people ages 16-24 disconnected from school and work
venues:
  - Oracle Park
  - Chase Center
contact:
  name: Michael Rivera
  role: Bay Area Site Director
  email: michaelr@juma.org
  phone: 415.371.0727
...
Reducing the number of youth disconnected from school and work requires unique and innovative cross-sector partnerships. To join us in this work or for more information about Juma's San Francisco/Bay Area program, please contact Chief Development Officer, Megan Hover, at [meganh@juma.org](mailto:meganh@juma.org) or Bay Area Site Director, Michael Rivera, at [michaelr@juma.org](mailto:michaelr@juma.org).

## San Francisco Office

Chief Development Officer: Megan Hover, [meganh@juma.org](mailto:meganh@juma.org)

Bay Area Site Director: Michael Rivera, [michaelr@juma.org](mailto:michaelr@juma.org)
